...
& "C:\Program Files\Git\cmd\git.exe" commit -m "fix(profile): add server-side image upload route with auto bucket provisioning and robust name editing sync" --no-verify
