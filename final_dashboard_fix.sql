-- Comprehensive Fix for Dashboard Visibility and Schema (Super Admin & Owner)
...
-------------------------------------------------------------------
-- The dashboards crash when sorting by created_at if it's missing!
